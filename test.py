...
img_name = sys.argv[1]
retvalue = os.system("./darknet detector test obj.data yolo-obj.cfg yolo-obj_2700.weights " + img_name)
coords = []
...
for line in range(0, int(count)):
    ...
    cv2.imwrite("wyniki/" + str(num) + "crop" + str(line) + ".jpg", crop_img)
    #aa(line)
